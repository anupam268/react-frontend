...
const rows = [
  ...
  createData("Eclair", 262, 16.0, 24, 6.0, "...", "https://www.google.com"),
  createData("Cupcake", 305, 3.7, 67, 4.3, "...", "https://www.google.com"),
  createData(
    "Gingerbread",
    356,
    16.0,
...
const SimpleTable = () => {
  ...
  const headCells = [
    ...
    { id: "actions", label: "Chart" }, // Added new column for actions
  ];
